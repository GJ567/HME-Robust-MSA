...
########################################################################################################################                
    def get_similar_embeddings(self, embeddings, alpha=0.8, top_k=None, temperature=None):
        """
        ...
        for i in range(batch_size):
            ...
            if valid_mask.any():
                ...
                # 根据相似度做 softmax 加权
                # 相似度越高，权重越大
                weights = F.softmax(selected_sims / temperature, dim=0).unsqueeze(1)
