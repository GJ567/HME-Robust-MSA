...
parser.add_argument("--lq_scenario", type=str, default="all", choices=["all", "text", "audio", "vision", "text_audio", "text_vision", "audio_vision"], help="low-quality scenario: which modality is selectively missing/degraded")
...
def train_epoch(model: nn.Module, train_dataloader: DataLoader, epoch=None):
    ...
    ps = generate_lq_missing_matrix(nums, 3, missing_rate=args.missing_rate, scenario=args.lq_scenario)
